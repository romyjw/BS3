...
proxy_filename = "twisted_torus500"
...
param_surface_filename = f"rendering_results/teaser/{proxy_filename}/param_fine.ply"
param_coarse_surface_filename = f"rendering_results/teaser/{proxy_filename}/param_coarse.ply"
param_unblended_surface_filename = f"rendering_results/teaser/{proxy_filename}/param_unblended.ply"




skeleton_filename= f"../data/surfaces/{proxy_filename}.obj"
...
param_surface_base = rotated(
    hkw.layer(param_surface_filename).material(
        "Principled",
...
unblended_param_layer = rotated(
    hkw.layer(param_unblended_surface_filename).material(
        "Principled",
        color=hkw.texture.ScalarField(
        data="param_colours",
        colormap="identity",
...
coarse_param_layer = rotated(
    hkw.layer(param_coarse_surface_filename).material(
        "Principled",
        color=hkw.texture.ScalarField(
        data="param_colours",
        colormap="identity",
...
hkw.render(
    param_surface_base ,
    config,
    filename=f"rendering_results/teaser/{proxy_filename}/blended_param.png",
)
...
hkw.render(
    all_skeleton_layers,
    config,
    filename=f"rendering_results/teaser/{proxy_filename}/skeleton.png",
)
...
hkw.render(
    unblended_param_layer ,
    config,
    filename=f"rendering_results/teaser/{proxy_filename}/unblended_param.png",
)
...
hkw.render(
    coarse_param_layer ,
    config,
    filename=f"rendering_results/teaser/{proxy_filename}/coarse_param.png",
)
